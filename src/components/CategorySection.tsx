...
const categories = [
  ...
  },
  {
    ...
    count: "NEW",
    image:
      "https://images.unsplash.com/photo-1525507119028-ed4c629a60a3?q=80&w=400&auto=format&fit=crop",
  ...
  },
  {
    ...
    color: "from-amber-50 dark:from-amber-900/10 to-transparent",
  },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((cat, idx) => (
            <Link
              ...
              key={idx}
              className="group relative h-[450px] rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-700"
            >
