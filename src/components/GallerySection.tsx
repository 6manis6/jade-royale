    ...
    <section className="py-24 bg-[var(--jade-bg)] border-t border-gray-100 dark:border-gray-800">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-16">
          <a href="https://www.instagram.com/jade.royale15/" target="_blank" rel="noopener noreferrer" className="inline-block group text-center">
            <h2 className="font-serif text-3xl md:text-4xl text-black mb-4 tracking-widest uppercase group-hover:text-[var(--color-jade-pink)] transition-colors">Instagram</h2>
            <p className="text-sm text-black font-bold tracking-wide group-hover:text-[var(--color-jade-pink)] transition-colors">@jade.royale15</p>
          </a>
